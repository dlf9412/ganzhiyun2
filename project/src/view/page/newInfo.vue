  ...
  <div class='newInfo'>
    ...
    <div class="contain_Msg">
      <div class="left">
        ...
        <div class="leftMsg" :class="{'leftMsgChose':leftMsgChose==1}" @click="changeType(1)"> > 公司新闻
        </div>
        <div class="leftMsg" :class="{'leftMsgChose':leftMsgChose==2}" @click="changeType(2)">> 行业新闻
        </div>
      </div>
      <div class="right">
        <div class="show1" v-if="choseIndex==-1">
          <div class="infoListData" v-for="(item,index) in infoList" :key="index" @click="chose(index)">
            <div>
              <span>·</span>
              {{item.title}}
            </div>
        ...
        <div class="show2" v-if='choseIndex!==-1'>
          这是详情页面
        </div>
...
<style>
  ...
  .newInfo .leftMsg:hover {
    background: rgb(251, 251, 251)
  }

  .newInfo .leftMsgChose {
    background: rgb(251, 251, 251);
