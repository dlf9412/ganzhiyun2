  ...
  <div class="page1">
    <div class="contain1">
      ...
      <el-upload
        ...
        ref="upload"
        action="http://120.79.222.61:5000/user/imgAdd?index=1"
    ...
    <div class="contain2">
      ...
      <el-upload
        class="upload-container"
        ref="upload1"
        action="http://120.79.222.61:5000/user/imgAdd?index=11"
        :on-preview="handlePreview"
        :before-remove="handleRemove"
        :file-list="fileList2"
        list-type="picture"
    ...
    <div class="contain3">
      ...
      <el-upload
        class="upload-container"
        ref="upload2"
        action="http://120.79.222.61:5000/user/imgAdd?index=12"
        :on-preview="handlePreview"
        :before-remove="handleRemove"
        :file-list="fileList3"
        list-type="picture"
    ...
    <div class="contain4">
      ...
      <el-upload
        class="upload-container"
        ref="upload3"
        action="http://120.79.222.61:5000/user/imgAdd?index=13"
        :on-preview="handlePreview"
        :before-remove="handleRemove"
        :file-list="fileList4"
        list-type="picture"
    ...
    <div class="contain5">
      ...
      <el-upload
        class="upload-container"
        ref="upload4"
        action="http://120.79.222.61:5000/user/imgAdd?index=14"
        :on-preview="handlePreview"
        :before-remove="handleRemove"
        :file-list="fileList5"
        list-type="picture"
    ...
    <div class="contain5">
      ...
      <el-upload
        class="upload-container"
        ref="upload5"
        action="http://120.79.222.61:5000/user/imgAdd?index=15"
        :on-preview="handlePreview"
        :before-remove="handleRemove"
        :file-list="fileList6"
        list-type="picture"
    ...
    <div class="contain6">
      ...
      <el-upload
        class="upload-container"
        ref="upload6"
        action="http://120.79.222.61:5000/user/imgAdd?index=16"
        :on-preview="handlePreview"
        :before-remove="handleRemove"
        :file-list="fileList7"
        list-type="picture"
    ...
    <div class="contain7">
      ...
      <el-upload
        class="upload-container"
        ref="upload7"
        action="http://120.79.222.61:5000/user/imgAdd?index=17"
        :on-preview="handlePreview"
        :before-remove="handleRemove"
        :file-list="fileList8"
        list-type="picture"
    ...
    <div class="contain8">
      ...
      <el-upload
        class="upload-container"
        ref="upload8"
        action="http://120.79.222.61:5000/user/imgAdd?index=18"
        :on-preview="handlePreview"
        :before-remove="handleRemove"
        :file-list="fileList9"
        list-type="picture"
